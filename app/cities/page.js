...
export const metadata = {
  title: "אחות פרטית בכל הארץ | סיעוד פרימיום — המרכז הארצי לליווי מוסמך",
  description:
  ...
  openGraph: {
    ...
    title: "אחות פרטית בפריסה ארצית — סיעוד פרימיום",
            ...
            <div className="mt-10 flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-5 max-w-2xl text-[16px] leading-relaxed text-slate-200 sm:text-[17px]">
                  סיעוד פרימיום מנגישה אחיות מוסמכות משרד הבריאות לכל שלב — אשפוז, שחרור, החלמה בבית והמשכיות טיפולית —
